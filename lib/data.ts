...
export const materialAssets: Asset[] = [
  ...
  // Glass Materials
  {
    ...
    thumbnail: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Oi9Sa3UunBnapX6O42kqyNE7gCmF5d.png',
    author: 'Emma Wilson',
  ...
  },
  {
    ...
    thumbnail: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-TquXZ3ZKrn74tvKCTh0ZuU77LUhita.png',
    author: 'Alex Turner',
  ...
  },
  {
    ...
    category: 'Materials',
    subcategory: 'Glass',
    tags: ['glass', 'tinted', 'red', 'automotive', 'warm'],
    description: 'Red tinted window glass with warm color cast and dynamic reflections.',
    thumbnail: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-6bEWK2Q2wERkz6cF5Bbj1SQr5V5nv5.png',
    author: 'Mike Johnson',
  ...
  {
    id: 'm7',
    name: 'Orange Textured Glass',
    category: 'Materials',
    subcategory: 'Glass',
    tags: ['glass', 'tinted', 'orange', 'textured', 'automotive'],
    description: 'Orange textured automotive glass with warm spectrum tinting and surface texture detail.',
    thumbnail: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-5DaPG7I15Tz1vZ7MWOAuS3Z92FL6Dl.png',
    author: 'Sarah Chen',
    ...
    files: [
      { id: '1', name: 'orange_textured_glass.sbsar', type: 'sbsar', size: '7.1 MB', sizeBytes: 7440384, downloadUrl: '#' },
      { id: '2', name: 'orange_textured_glass_albedo_8k.png', type: 'png', size: '19.4 MB', sizeBytes: 20345856, downloadUrl: '#' },
      { id: '3', name: 'orange_textured_glass_normal_8k.png', type: 'png', size: '17.7 MB', sizeBytes: 18554880, downloadUrl: '#' }
    ],
    isFavorite: false
  },
